...
import { replaceTopicSubscriptionFunctionWithAlias, replaceSubscriptionFunctionWithAlias } from './Sns.js'
...
describe('Sns', () => {
  describe('.replaceTopicSubscriptionFunctionWithAlias', () => {
    ...
    it("replaces the topic subscription's function for an alias", () => {
      ...
      const actual = replaceTopicSubscriptionFunctionWithAlias(snsTopic, functionAlias, functionName)
  ...
  describe('.replaceSubscriptionFunctionWithAlias', () => {
    ...
    it("replace the sns subscription's function for an alias", () => {
      ...
      const actual = replaceSubscriptionFunctionWithAlias(snsSubscription, functionAlias, functionName)
      expect(actual).to.deep.equal(expected)
    })
  })
})
