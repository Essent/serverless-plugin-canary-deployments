...
export function buildCodeDeployRole (codeDeployRolePermissionsBoundaryArn, areTriggerConfigurationsSet) {
...
export function buildExecutionRoleWithCodeDeploy (inputRole, codeDeployAppName, deploymentGroups) {
