...
import { replaceCloudWatchEventRuleTargetWithAlias } from './CloudWatchEvents.js'
...
describe('CloudWatchEvents', () => {
  describe('.replaceCloudWatchEventRuleTargetWithAlias', () => {
    ...
    it("replaces the event rule target's function for an alias", () => {
      ...
      const actual = replaceCloudWatchEventRuleTargetWithAlias(cloudWatchEvent, functionAlias, functionName)
